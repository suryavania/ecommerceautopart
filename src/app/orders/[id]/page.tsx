...
const PAYMENT_INFO: Record<string, { bank: string; noRek: string; atasnama: string; color: string }> = {
  bca:     { bank: 'BCA',     noRek: '7731-5280-4692', atasnama: 'PT AutoPart Indonesia', color: 'bg-blue-700'   },
  mandiri: { bank: 'Mandiri', noRek: '1380-0057-2947-6381', atasnama: 'PT AutoPart Indonesia', color: 'bg-yellow-500' },
  bni:     { bank: 'BNI',     noRek: '0473-8261-59',   atasnama: 'PT AutoPart Indonesia', color: 'bg-orange-600' },
}
